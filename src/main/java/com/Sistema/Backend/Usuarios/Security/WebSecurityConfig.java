...
import com.Sistema.Backend.Usuarios.Security.Services.UserDetailsServiceImpl;
import com.Sistema.Backend.Usuarios.Security.jwt.AuthEntryPointJwt;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // Añadimos nuestro filtro JWT antes del filtro de autenticación por defecto de Spring
